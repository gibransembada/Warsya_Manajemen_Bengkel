...
void main() async {
  ...
  // Gambar ikon kunci pas (wrench) yang lebih sederhana
  final wrenchPaint = Paint()
    ..color = Colors.white
    ..style = PaintingStyle.stroke
    ..strokeWidth = 80;

  // Gambar kunci pas sederhana
  final path = Path();
  // Bagian kepala kunci pas
  path.moveTo(300, 300);
  path.lineTo(500, 500);
  path.lineTo(600, 400);
  path.lineTo(400, 200);
  ...
  // Lingkaran untuk kepala kunci pas
  canvas.drawCircle(const Offset(350, 250), 80, wrenchPaint);
  ...
  textPainter.paint(
      ...
      Offset(
        ...
        (size.height - textPainter.height) / 2 + 250,
      ));
  ...
  print('📱 Sekarang jalankan: flutter pub run flutter_launcher_icons:main');
}
